...
def create_admin():
    ...
    print 'creating admin@brolewis.com'
    password = flask.ext.security.utils.encrypt_password(getpass.getpass())
    main.user_datastore.create_user(email='admin@brolewis.com',
                                    password=password)
...
def create_defaults():
    ...
    for group_name in groups:
        ...
        for label in groups[group_name]:
            ...
            if not action:
                action = main.models.Action(label=label)
